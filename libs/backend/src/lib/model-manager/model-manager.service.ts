...
const KNOWN_MODELS: ModelInfo[] = [
  ...
  },
  {
    ...
    type: 'stt',
    url: 'https://github.com/k2-fsa/sherpa-onnx/releases/download/asr-models/sherpa-onnx-whisper-small.int8.tar.bz2',
    size: '~245 Mo',
    description: 'Transcription multilingue - excellent français (OpenAI)',
    filename: 'sherpa-onnx-whisper-small.int8.tar.bz2',
    checkFile: 'whisper-small-encoder.int8.onnx',
    archive: true,
  },
  {
